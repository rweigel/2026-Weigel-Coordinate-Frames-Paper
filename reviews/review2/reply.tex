...
``New standards should also address the decision to stop using leap seconds (Gibney (2022); Palmer (2023)), which will affect approximations such as the use of UTC in place of UT1.''
...
{\color{violet}
\begin{leftbar}
We have added ``active ranging'' to the list of position sources.
\end{leftbar}
}
