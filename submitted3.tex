...
There is an additional source of uncertainty --- the source of the positions. Missions have used direct Doppler and GNSS measurements, commercial software such as STK (Systems Tool Kit), and data from facilities such as the GSFC Flight Dynamics Facility (FDF), the Deep Space Network (DSN), NAIF, and NORAD to produce the spacecraft positions for the mission.
